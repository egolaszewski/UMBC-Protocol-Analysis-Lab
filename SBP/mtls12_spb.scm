...
(defprotocol ca basic
  ...
  (defrole clienta ;; Role in which the client authenticates with password
    ...
    (trace
     (mTLS send recv pms cr sr c s ca) ;; establish mTLS session with server
  ...
  (defrole servera ;; Role where server authenticates user with password and
    ...
    (trace
     (mTLS recv send pms cr sr c s ca) ;; establish mTLS session with client
...
(defskeleton ca
  ...
  (defstrandmax clienta (u u) (p p) (s s) (c c) (ca ca) (cr cr) (sr sr)
    (pms pms))
  (pen-non-orig p)
  (non-orig (privk ca) (privk s) (privk c))
  (uniq-orig cr pms)
...
(defskeleton ca
  (vars (c u s ca name) (p password) (cr sr random32) (pms random48)
	(cookie data))
  (defstrandmax clienta (u u) (p p) (s s) (c c) (ca ca) (cr cr) (sr sr) (pms pms)
    (cookie cookie))
  (deflistener cookie)
  (pen-non-orig p)
  (non-orig (privk ca) (privk s) (privk c))
...
(defskeleton ca
  (vars (c s ca name) (cr sr random32) (pms random48))
  (defstrandmax clientr (s s) (c c) (ca ca) (cr cr) (sr sr) (pms pms))
  (non-orig (privk ca) (privk s) (privk c))
  (uniq-orig cr pms)
  (uniq-orig sr) ;; This is only included to prevent multiple runs of the same
  ;; server interacting with the same client.  (When removed has no impact on
...
(defskeleton ca
  (vars (c s ca name) (cr sr random32) (pms random48) (cookie data))
  (defstrand servera 9 (s s) (c c) (ca ca) (cr cr) (sr sr) (pms pms)
    (cookie cookie))
  (non-orig (privk ca) (privk s) (privk c))
  (uniq-orig sr cookie)
  )
...
(defskeleton ca
  (vars (c s ca name) (cr sr random32) (pms random48))
  (defstrand serverr 6 (s s) (c c) (ca ca) (cr cr) (sr sr) (pms pms))
  (non-orig (privk ca) (privk s) (privk c))
  (uniq-orig sr)
  )
...
(defgoal ca
  (forall
	...
	(p "clienta" "c" z c)
        ...
        (non (privk c)) (non (privk s)) (non (privk ca)) (pnon p) (uniq sr)
