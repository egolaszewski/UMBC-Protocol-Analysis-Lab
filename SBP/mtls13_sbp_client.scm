...
(defprotocol ca basic
  ...
  (mtls-hs-traffic-keys-unavailable1)
...
(defskeleton ca
  (vars (c u s ca name) (spk cpk akey) (x rndx) (y expt) (p password)
	(cr sr random32))
  (defstrand clienta 9 (u u) (p p) (c c) (cpk cpk) (s s) (spk spk) (ca ca)
    (cr cr) (sr sr) (x x) (y y))
...
(defskeleton ca
  (vars (c u s ca name) (spk cpk akey) (p password) (cr sr random32)
	(cookie data))
  (defstrandmax clienta (u u) (p p) (c c) (cpk cpk) (s s) (spk spk) (ca ca)
    (cr cr) (sr sr) (cookie cookie))
  (deflistener cookie)
  (pen-non-orig p)
  (non-orig (privk ca) (invk spk) (invk cpk))
  (uniq-orig cr)
...
(defskeleton ca
  ...
  (defstrandmax clientr (c c) (cpk cpk) (s s) (spk spk) (ca ca) (cr cr) (sr sr))
  (non-orig (privk ca) (invk spk) (invk cpk))
  (uniq-orig cr)
  (uniq-orig sr) ;; This is only included to prevent multiple runs of the same
  ;; server interacting with the same client.
